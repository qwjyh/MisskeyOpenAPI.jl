...
"""
Base.@kwdef mutable struct MetaDetailed <: OpenAPI.APIModel
    ...
    function MetaDetailed(maintainerName, maintainerEmail, version, providesTarball, name, shortName, uri, description, langs, tosUrl, repositoryUrl, feedbackUrl, defaultDarkTheme, defaultLightTheme, disableRegistration, emailRequiredForSignup, enableHcaptcha, hcaptchaSiteKey, enableMcaptcha, mcaptchaSiteKey, mcaptchaInstanceUrl, enableRecaptcha, recaptchaSiteKey, enableTurnstile, turnstileSiteKey, swPublickey, mascotImageUrl, bannerUrl, serverErrorImageUrl, infoImageUrl, notFoundImageUrl, iconUrl, maxNoteTextLength, ads, notesPerOneAd, enableEmail, enableServiceWorker, translatorAvailable, mediaProxy, enableUrlPreview, backgroundImageUrl, impressumUrl, logoImageUrl, privacyPolicyUrl, inquiryUrl, serverRules, themeColor, policies, features, proxyAccountName, requireSetup, cacheRemoteFiles, cacheRemoteSensitiveFiles, )
        OpenAPI.validate_property(MetaDetailed, Symbol("maintainerName"), maintainerName)
        OpenAPI.validate_property(MetaDetailed, Symbol("maintainerEmail"), maintainerEmail)
        OpenAPI.validate_property(MetaDetailed, Symbol("version"), version)
        OpenAPI.validate_property(MetaDetailed, Symbol("providesTarball"), providesTarball)
        OpenAPI.validate_property(MetaDetailed, Symbol("name"), name)
        OpenAPI.validate_property(MetaDetailed, Symbol("shortName"), shortName)
        OpenAPI.validate_property(MetaDetailed, Symbol("uri"), uri)
        OpenAPI.validate_property(MetaDetailed, Symbol("description"), description)
        OpenAPI.validate_property(MetaDetailed, Symbol("langs"), langs)
        OpenAPI.validate_property(MetaDetailed, Symbol("tosUrl"), tosUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("repositoryUrl"), repositoryUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("feedbackUrl"), feedbackUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("defaultDarkTheme"), defaultDarkTheme)
        OpenAPI.validate_property(MetaDetailed, Symbol("defaultLightTheme"), defaultLightTheme)
        OpenAPI.validate_property(MetaDetailed, Symbol("disableRegistration"), disableRegistration)
        OpenAPI.validate_property(MetaDetailed, Symbol("emailRequiredForSignup"), emailRequiredForSignup)
        OpenAPI.validate_property(MetaDetailed, Symbol("enableHcaptcha"), enableHcaptcha)
        OpenAPI.validate_property(MetaDetailed, Symbol("hcaptchaSiteKey"), hcaptchaSiteKey)
        OpenAPI.validate_property(MetaDetailed, Symbol("enableMcaptcha"), enableMcaptcha)
        OpenAPI.validate_property(MetaDetailed, Symbol("mcaptchaSiteKey"), mcaptchaSiteKey)
        OpenAPI.validate_property(MetaDetailed, Symbol("mcaptchaInstanceUrl"), mcaptchaInstanceUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("enableRecaptcha"), enableRecaptcha)
        OpenAPI.validate_property(MetaDetailed, Symbol("recaptchaSiteKey"), recaptchaSiteKey)
        OpenAPI.validate_property(MetaDetailed, Symbol("enableTurnstile"), enableTurnstile)
        OpenAPI.validate_property(MetaDetailed, Symbol("turnstileSiteKey"), turnstileSiteKey)
        OpenAPI.validate_property(MetaDetailed, Symbol("swPublickey"), swPublickey)
        OpenAPI.validate_property(MetaDetailed, Symbol("mascotImageUrl"), mascotImageUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("bannerUrl"), bannerUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("serverErrorImageUrl"), serverErrorImageUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("infoImageUrl"), infoImageUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("notFoundImageUrl"), notFoundImageUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("iconUrl"), iconUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("maxNoteTextLength"), maxNoteTextLength)
        OpenAPI.validate_property(MetaDetailed, Symbol("ads"), ads)
        OpenAPI.validate_property(MetaDetailed, Symbol("notesPerOneAd"), notesPerOneAd)
        OpenAPI.validate_property(MetaDetailed, Symbol("enableEmail"), enableEmail)
        OpenAPI.validate_property(MetaDetailed, Symbol("enableServiceWorker"), enableServiceWorker)
        OpenAPI.validate_property(MetaDetailed, Symbol("translatorAvailable"), translatorAvailable)
        OpenAPI.validate_property(MetaDetailed, Symbol("mediaProxy"), mediaProxy)
        OpenAPI.validate_property(MetaDetailed, Symbol("enableUrlPreview"), enableUrlPreview)
        OpenAPI.validate_property(MetaDetailed, Symbol("backgroundImageUrl"), backgroundImageUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("impressumUrl"), impressumUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("logoImageUrl"), logoImageUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("privacyPolicyUrl"), privacyPolicyUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("inquiryUrl"), inquiryUrl)
        OpenAPI.validate_property(MetaDetailed, Symbol("serverRules"), serverRules)
        OpenAPI.validate_property(MetaDetailed, Symbol("themeColor"), themeColor)
        OpenAPI.validate_property(MetaDetailed, Symbol("policies"), policies)
        OpenAPI.validate_property(MetaDetailed, Symbol("features"), features)
        OpenAPI.validate_property(MetaDetailed, Symbol("proxyAccountName"), proxyAccountName)
        OpenAPI.validate_property(MetaDetailed, Symbol("requireSetup"), requireSetup)
        OpenAPI.validate_property(MetaDetailed, Symbol("cacheRemoteFiles"), cacheRemoteFiles)
        OpenAPI.validate_property(MetaDetailed, Symbol("cacheRemoteSensitiveFiles"), cacheRemoteSensitiveFiles)
        return new(maintainerName, maintainerEmail, version, providesTarball, name, shortName, uri, description, langs, tosUrl, repositoryUrl, feedbackUrl, defaultDarkTheme, defaultLightTheme, disableRegistration, emailRequiredForSignup, enableHcaptcha, hcaptchaSiteKey, enableMcaptcha, mcaptchaSiteKey, mcaptchaInstanceUrl, enableRecaptcha, recaptchaSiteKey, enableTurnstile, turnstileSiteKey, swPublickey, mascotImageUrl, bannerUrl, serverErrorImageUrl, infoImageUrl, notFoundImageUrl, iconUrl, maxNoteTextLength, ads, notesPerOneAd, enableEmail, enableServiceWorker, translatorAvailable, mediaProxy, enableUrlPreview, backgroundImageUrl, impressumUrl, logoImageUrl, privacyPolicyUrl, inquiryUrl, serverRules, themeColor, policies, features, proxyAccountName, requireSetup, cacheRemoteFiles, cacheRemoteSensitiveFiles, )
    end
end # type MetaDetailed

const _property_types_MetaDetailed = Dict{Symbol,String}(Symbol("maintainerName")=>"String", Symbol("maintainerEmail")=>"String", Symbol("version")=>"String", Symbol("providesTarball")=>"Bool", Symbol("name")=>"String", Symbol("shortName")=>"String", Symbol("uri")=>"String", Symbol("description")=>"String", Symbol("langs")=>"Vector{String}", Symbol("tosUrl")=>"String", Symbol("repositoryUrl")=>"String", Symbol("feedbackUrl")=>"String", Symbol("defaultDarkTheme")=>"String", Symbol("defaultLightTheme")=>"String", Symbol("disableRegistration")=>"Bool", Symbol("emailRequiredForSignup")=>"Bool", Symbol("enableHcaptcha")=>"Bool", Symbol("hcaptchaSiteKey")=>"String", Symbol("enableMcaptcha")=>"Bool", Symbol("mcaptchaSiteKey")=>"String", Symbol("mcaptchaInstanceUrl")=>"String", Symbol("enableRecaptcha")=>"Bool", Symbol("recaptchaSiteKey")=>"String", Symbol("enableTurnstile")=>"Bool", Symbol("turnstileSiteKey")=>"String", Symbol("swPublickey")=>"String", Symbol("mascotImageUrl")=>"String", Symbol("bannerUrl")=>"String", Symbol("serverErrorImageUrl")=>"String", Symbol("infoImageUrl")=>"String", Symbol("notFoundImageUrl")=>"String", Symbol("iconUrl")=>"String", Symbol("maxNoteTextLength")=>"Float64", Symbol("ads")=>"Vector{MetaLiteAdsInner}", Symbol("notesPerOneAd")=>"Float64", Symbol("enableEmail")=>"Bool", Symbol("enableServiceWorker")=>"Bool", Symbol("translatorAvailable")=>"Bool", Symbol("mediaProxy")=>"String", Symbol("enableUrlPreview")=>"Bool", Symbol("backgroundImageUrl")=>"String", Symbol("impressumUrl")=>"String", Symbol("logoImageUrl")=>"String", Symbol("privacyPolicyUrl")=>"String", Symbol("inquiryUrl")=>"String", Symbol("serverRules")=>"Vector{String}", Symbol("themeColor")=>"String", Symbol("policies")=>"RolePolicies", Symbol("features")=>"MetaDetailedOnlyFeatures", Symbol("proxyAccountName")=>"String", Symbol("requireSetup")=>"Bool", Symbol("cacheRemoteFiles")=>"Bool", Symbol("cacheRemoteSensitiveFiles")=>"Bool", )
OpenAPI.property_type(::Type{ MetaDetailed }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_MetaDetailed[name]))}

function check_required(o::MetaDetailed)
...
function OpenAPI.validate_property(::Type{ MetaDetailed }, name::Symbol, val)
    if name === Symbol("uri")
        OpenAPI.validate_param(name, "MetaDetailed", :format, val, "url")
    end
end
